...
const NAV_ITEMS = [
  { icon: Clock,       label: "Recent",      view: "recent",   href: "/dashboard?view=recent",   id: "sidebar-recent" },
  { icon: LayoutGrid,  label: "My Boards",   view: "mine",     href: "/dashboard?view=mine",     id: "sidebar-mine" },
  { icon: Star,        label: "Starred",     view: "starred",  href: "/dashboard?view=starred",  id: "sidebar-starred" },
  { icon: Users,       label: "Shared",      view: "shared",   href: "/dashboard?view=shared",   id: "sidebar-shared" },
  { icon: Trash2,      label: "Trash",       view: "trash",    href: "/dashboard?view=trash",    id: "sidebar-trash" },
];

function NavLinks() {
  const pathname = usePathname();
  const searchParams = useSearchParams();
  const currentView = searchParams.get("view") || "mine";
...
function NavLinksFallback() {
  ...
  return (
    <>
      {NAV_ITEMS.map((item) => {
        const Icon = item.icon;
        const isActive = pathname === "/dashboard" && item.view === "mine";
        return (
          <Link
            key={item.id}
            href={item.href}
